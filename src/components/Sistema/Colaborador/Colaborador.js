...
import { getAllColaborador, setColaborador, updateColaborador, EstadoColaborador } from '../../../services/colaborador';
...
const Colaborador = () => {
    ...
    const columns = [
        ...
        { name: 'Tipo Colaborador', selector: row => row.tipo_colaborador, sortable: true },
        { 
            name: 'ESTADO', 
            cell: row => (
                <span style={{ 
