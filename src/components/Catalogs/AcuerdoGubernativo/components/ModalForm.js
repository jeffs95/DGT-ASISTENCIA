...
const ModalForm = ({ show, handleClose, idAcuerdoGubernativo, acuerdoGubernativoData, onSubmit }) => {
    ...
    return (
        <Modal show={show} onHide={handleClose} centered>
            <Modal.Header closeButton>
                <Modal.Title>{idAcuerdoGubernativo ? 'Editar' : 'Agregar'} Acuerdo Gubernativo</Modal.Title>
            </Modal.Header>
            <Modal.Body>
