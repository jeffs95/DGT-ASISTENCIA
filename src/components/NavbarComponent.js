...
const components = [
  {
    name: "Asistencia",
    path: "/home",
    icon: <FaHome className="me-2 text-primary" />,
  },
  {
    name: "Visitas",
    path: "/Accesos",
  ...
  },
  {
    name: "Colaboradores",
    path: "/colaborador",
    icon: <FaUserTie className="me-2 text-primary" />,
  },
  {
    name: "Usuarios",
    path: "/usuario",
    icon: <FaUserCog className="me-2 text-primary" />,
  },
  {
    name: "Ingreso",
    path: "/ingreso",
    icon: <FaSignInAlt className="me-2 text-primary" />,
  },
  {
    name: "Departamento",
    path: "/departamento",
...
const NavbarComponent = () => {
  ...
  useEffect(() => {
    reactLocalStorage.getObject("permision");
  ...
  return (
    <Navbar
      expand="lg"
      className="bg-white shadow-sm rounded px-3"
          ...
          <Nav className="me-auto">
            ...
            {hasPermission && (
              <Dropdown drop="end" className="mx-2">
                <Dropdown.Toggle
                  variant="light"
                  className="fw-bold shadow-sm border"
                >
                  Catálogos
                </Dropdown.Toggle>
